...
public partial class RentalEvSystemFinalContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cccd>(entity =>
        {
            ...
            entity.Property(e => e.url_Cccd_Cmnd)
                .HasMaxLength(255)
                .HasColumnName("url_cccd_cmnd");
        ...
        {
            entity.HasKey(e => e.RenterId).HasName("PK__Driver_L__50438F0B35A50651");
            ...
            entity.Property(e => e.UrlDriverLicense)
                .HasMaxLength(255)
                .HasColumnName("url_driver_license");

            entity.HasOne(d => d.Renter).WithOne(p => p.DriverLicense)
                .HasForeignKey<DriverLicense>(d => d.RenterId)
        ...
        modelBuilder.Entity<VehicleModel>(entity =>
        {
            ...
            entity.Property(e => e.Model).HasDefaultValue(100).HasColumnName("model");
        });
