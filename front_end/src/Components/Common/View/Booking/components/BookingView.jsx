  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <button 
            className="flex items-center gap-2 text-green-600 hover:text-green-700 font-semibold transition-colors mb-4" 
            onClick={onCancel}
          >
            ← Quay lại
          </button>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden sticky top-24">
              ...
              <div className="p-6">
                ...
                <p className="text-3xl font-bold text-green-600 mb-4">{vehicle.price}k VNĐ/ngày</p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 space-y-3">
                  ...
                  <div className="border-t-2 border-indigo-200 pt-3 flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-green-600">{calculateTotalPrice().toLocaleString('vi-VN')} VNĐ</span>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    className="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    onClick={onProceedToContract}
                    disabled={!bookingData.startDate || !bookingData.endDate || !bookingData.phone || isSubmitting}
                  >
                    {isSubmitting ? '⏳ Đang tạo booking...' : 'Tiếp tục → Tạo hợp đồng'}
                  </button>
                </div>
              </div>
            </div>
