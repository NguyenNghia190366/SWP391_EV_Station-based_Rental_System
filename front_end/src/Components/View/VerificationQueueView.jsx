  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f8f9fa" }}>
      ...
      <Navbar bg="dark" variant="dark" className="shadow-sm mb-4">
        <Container>
          <Navbar.Brand onClick={() => onNavigate?.("/home")} style={{ cursor: "pointer" }}>
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            {staffInfo && (
              <Dropdown align="end">
                ...
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => onNavigate?.("/staff/dashboard")}>
                    Dashboard
                  </Dropdown.Item>
                  <Dropdown.Divider />
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    ...
                    <p className="text-muted mb-0">
                      Có <strong>{totalPending}</strong> người dùng đang chờ xác thực
                    </p>
                  </div>
                        ...
                        <div className="d-flex align-items-start gap-3">
                          ...
                          <div className="flex-grow-1">
                            ...
                            <p className="text-muted small mb-0 mt-2">
                              Đăng ký: {new Date(user.createdAt || Date.now()).toLocaleDateString("vi-VN")}
                            </p>
                          </div>
                        </div>
                      </ListGroup.Item>
                ...
                {!selectedUser ? (
                  ...
                  <div>
                      ...
                      <Row className="g-3">
                        ...
                        <Col md={6}>
                          <div className="p-3 bg-light rounded">
                            ...
                            <div className="fw-semibold">{selectedUser.phone || "N/A"}</div>
                          </div>
                        </Col>
                        <Col md={6}>
                          <div className="p-3 bg-light rounded">
                            <div className="text-muted small">CMND/CCCD</div>
                            <div className="fw-semibold">{selectedUser.idCard || "N/A"}</div>
                          </div>
                        </Col>
                        <Col md={12}>
                          <div className="p-3 bg-light rounded">
                            <div className="text-muted small">Giấy phép lái xe</div>
                            <div className="fw-semibold">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="mb-3">
                        <div className="d-flex justify-content-between align-items-center mb-2">
                          <small className="fw-semibold">Hình ảnh CMND/CCCD</small>
                          {selectedUser.idCardImage && (
                            <Button
                              size="sm"
                              variant="outline-primary"
                              onClick={() => onViewDocument?.(selectedUser.idCardImage, "CMND")}
                            >
                              🔍 Xem toàn màn hình
                            </Button>
                          )}
                        ...
                        <div className="d-flex justify-content-between align-items-center mb-2">
                          ...
                          {selectedUser.driverLicenseImage && (
                            <Button
                              ...
                              variant="outline-primary"
                              onClick={() =>
                                onViewDocument?.(selectedUser.driverLicenseImage, "GPLX")
                              }
                            >
                              🔍 Xem toàn màn hình
                            </Button>
                    ...
                    <Alert variant="info" className="mb-3">
                      <small>
                        💡 <strong>Lưu ý:</strong> Kiểm tra kỹ thông tin và giấy tờ trước khi xác thực
                      </small>
                    </Alert>
